...
bool
modm::platform::Adc1::enableChannelOffset(const OffsetSlot slot, const Channel channel, const int16_t offset,
	const bool saturate)
{
	if ( (ADC1->CR & ADC_CR_JADSTART) || (ADC1->CR & ADC_CR_ADSTART) ) {
