...
void
modm::platform::Adc4::enableRegularConversionExternalTrigger(
	...
	RegularConversionExternalTrigger regularConversionExternalTrigger)
{
	...
	ADC4->CFGR = (ADC4->CFGR & ~mask) | polarity | externalTrigger;
}

void
modm::platform::Adc4::disableRegularConversionExternalTrigger()
{
	// Disable regular conversions external trigger by clearing the bits
	// for polarity and external trigger source.
	ADC4->CFGR &= ~(ADC_CFGR_EXTEN_Msk | ADC_CFGR_EXTSEL_Msk);
}
...
void
modm::platform::Adc4::enableInjectedConversionExternalTrigger(
	ExternalTriggerPolarity externalTriggerPolarity,
	RegularConversionExternalTrigger regularConversionExternalTrigger)
{
	...
	ADC4->JSQR = (ADC4->JSQR & ~mask) | polarity | externalTrigger;
}

void
modm::platform::Adc4::disableInjectedConversionExternalTrigger()
{
	// Disable injected conversions external trigger by clearing the bits
	// for polarity and external trigger source.
	ADC4->JSQR &= ~(ADC_JSQR_JEXTEN_Msk | ADC_JSQR_JEXTSEL_Msk);
}
...
bool
modm::platform::Adc4::enableChannelOffset( const OffsetSlot slot, const Channel channel, const int16_t offset, const bool saturate)
{
	...
	if ((ADC4->CR & ADC_CR_JADSTART) || (ADC4->CR & ADC_CR_ADSTART))
	{
	...
	switch (slot)
	{
		case OffsetSlot::Slot0: ADC4->OFR1 = offsetValue;	break;
		case OffsetSlot::Slot1: ADC4->OFR2 = offsetValue;	break;
		case OffsetSlot::Slot2: ADC4->OFR3 = offsetValue;	break;
		case OffsetSlot::Slot3: ADC4->OFR4 = offsetValue;	break;
		default:
...
bool
modm::platform::Adc4::disableChannelOffset(const OffsetSlot slot)
{
	if ( (ADC4->CR & ADC_CR_JADSTART) || (ADC4->CR & ADC_CR_ADSTART) ) {
	...
	switch (slot)
	{
		case OffsetSlot::Slot0: ADC4->OFR1 &= ~enableMask;	break;
		case OffsetSlot::Slot1: ADC4->OFR2 &= ~enableMask; break;
		case OffsetSlot::Slot2: ADC4->OFR3 &= ~enableMask; break;
		case OffsetSlot::Slot3: ADC4->OFR4 &= ~enableMask; break;
		default:
			return false;  // invalid slot
	}
	return true;
