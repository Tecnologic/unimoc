 ...
 * \ingroup	modm_platform_adc modm_platform_adc_5
 */
class Adc5
{
...
public:
	...
	connect()
	{
		using Connector = GpioConnector<Peripheral::Adc5, Signals...>;
		Connector::connect();
	}
	...
	getPinChannel()
	{
		constexpr int8_t channel{detail::AdcChannel<typename Gpio::Data, Peripheral::Adc5>};
		static_assert(channel >= 0, "Adc5 does not have a channel for this pin!");
...
#include "adc_5_impl.hpp"

#endif	// MODM_STM32F3_ADC5_HPP